  ...
  if (headerPlaceholder) {
    fetch('/components/header.html')
      ...
      .then(data => {
        ...
        // Wait for header to load before attaching event listeners
        initHeaderFeatures();
      });
  }
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function updateThemeIcon(isDark) {
    themeIcon.innerHTML = isDark
      ? `<path fill="currentColor" d="M17.75 15.5A6.75 6.75 0 018.5 6.25a7 7 0 109.25 9.25z"/>` // Moon icon
      : `<path d="M12 3v1M12 20v1M4.22 4.22l.7.7M18.36 18.36l.7.7M1 12h1M20 12h1M4.22 19.78l.7-.7M18.36 5.64l.7-.7M12 5a7 7 0 100 14 7 7 0 000-14z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>`; // Sun icon
  }
